      ...
      <section className="py-16 md:py-32 dark:bg-transparent">
        <div className="mx-auto max-w-3xl lg:max-w-5xl px-6">
          <div className="relative">
            <div className="lab-bg absolute inset-0 -z-0" />
            <div className="relative z-10 grid grid-cols-6 gap-3">

              {/* Card 1 — 24/7 Siempre activo */}
              <Card className="relative col-span-full flex overflow-hidden lg:col-span-2 dark:border-white/10">
                <CardContent className="relative m-auto size-fit pt-6">
                  ...
                  <h2 className="mt-6 text-center text-3xl font-semibold dark:text-white">Siempre activo</h2>
                </CardContent>
              </Card>

              {/* Card 2 — No auditamos una vez */}
              <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 dark:border-white/10">
                ...
                <CardContent className="pt-6">
                  <div className="pt-6 lg:px-6">
                    <svg className="dark:text-muted-foreground w-full" viewBox="0 0 386 123" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <defs>
                        <linearGradient id="paint0_feat3" x1="3" y1="60" x2="3" y2="123" gradientUnits="userSpaceOnUse">
                  ...
                  <div className="relative z-10 mt-14 space-y-2 text-center">
                    <h2 className="text-lg font-medium transition dark:text-white">IA + ofensiva + automatización</h2>
              ...
              {/* Card 4 — Red Team */}
              <Card className="relative col-span-full overflow-hidden lg:col-span-3 dark:border-white/10">
                <CardContent className="grid pt-6 sm:grid-cols-2">
                  <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                    ...
                    <div className="space-y-2">
                      <h2 className="text-lg font-medium text-zinc-800 transition dark:text-white">Red Team Especializado</h2>
                      <p className="text-foreground text-sm">Operadores con años de experiencia en entornos donde el fallo no es una opción.</p>
                    </div>
                  </div>
                  <div className="rounded-tl-lg relative -mb-6 -mr-6 mt-6 h-fit border-l border-t p-6 py-6 sm:ml-6 dark:border-white/10">
              ...
              {/* Card 5 — Seguro desde el primer commit */}
              <Card className="relative col-span-full overflow-hidden lg:col-span-3 dark:border-white/10">
                <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                  <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                    ...
                    <div className="space-y-2">
                      <h2 className="text-lg font-medium transition dark:text-white">Seguro desde el primer commit</h2>
                  ...
                  <div className="relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px before:bg-[var(--color-border)] sm:-my-6 sm:-mr-6">
                    <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                      <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                        <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm dark:border-white/10 dark:text-white">PTSaaS</span>
                        <div className="ring-background size-7 ring-4 rounded-full bg-zinc-900 flex items-center justify-center">
                          <span className="text-white text-xs font-bold">BS</span>
                        </div>
                      </div>
                      <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
                        <div className="ring-background size-8 ring-4 rounded-full bg-red-700 flex items-center justify-center">
                          <Shield className="size-4 text-white" strokeWidth={1.5} />
                        </div>
                        <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm dark:border-white/10 dark:text-white">Red Team</span>
                      </div>
                      <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                        <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm dark:border-white/10 dark:text-white">IA Activa</span>
                        <div className="ring-background size-7 ring-4 rounded-full bg-zinc-700 flex items-center justify-center">
